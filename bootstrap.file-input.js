...
var $ = require('jquery');
module.exports = exports = function(ele) {
$('input[type=file]', ele).each(function(i,elem){
  ...
  .promise().done( function(){
    ...
    $('.file-input-wrapper', ele).mousemove(function(cursor) {
    ...
    $('.file-input-wrapper input[type=file]', ele).change(function(){
